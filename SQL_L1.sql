...
-- hey hello bitch commenting here

select database();

show tables;    -- display tables

create table tushar(salery int, age int);
show tables;
...
--to create a table 
create table table_name(coulumn datatype,column2 datatype);

-- table description - to see column name and datatype
describe table_name;
...
select * from city;			-- * means give all 
...
select population,name,district from city;
 ...
 -- quaries can be written in multiple lines
 select name,population,
	countrycode from city;

select *,population+12+14+18 as 'new_population' from country;

-- learn :- what is database?
		-- what is file system and how is it diff from dbms
        -- types of DBMS
        -- DBMS vs RDBMS
